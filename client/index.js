...
var old_key = document.getElementById('old-key').value;
var new_name=document.getElementById('name-update').value;
var new_color=document.getElementById('color-update').value;
